...
import { Bell, Settings, Star, Trash2, Edit } from 'lucide-react';
import
  {
    Card,
    CardContent,
            ...
            <Card className="col-span-full md:col-span-1">
              ...
              <CardContent>
                <div className="space-y-4">
                  {calculateDashboardStats().topPerformers.map((emp) => (
                  ...
                  <div key={employee.id} className="flex items-center justify-between p-4 rounded-lg border">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full ${employee.availability === 'available' ? 'bg-green-100 text-green-800' :
              ...
              <div className="space-y-4">
                {clients.map((client) => (
                  <div key={client.id} className="flex items-center justify-between p-4 rounded-lg border">
                    ...
                    <div className="flex items-center gap-4">
                      <span className={`px-2 py-1 rounded-full text-sm ${client.status === 'active' ? 'bg-green-100 text-green-800' :
                  ...
                  <div key={project.id} className="p-4 rounded-lg border">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-1 rounded-full text-sm ${project.status === 'in-progress' ? 'bg-blue-100 text-blue-800' :
