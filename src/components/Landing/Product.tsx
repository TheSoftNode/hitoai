...
//     return (
//         <div className="bg-gradient-to-br from-blue-900 to-indigo-800 min-h-screen flex flex-col items-center justify-center py-16 px-4">
//             <motion.h2
...
//                 <button
//                     onClick={prevSlide}
//                     className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 lg:-translate-x-12 z-10 bg-white rounded-full p-3 shadow-lg hover:bg-gray-100 transition-all"
//                 >
//                     <ChevronLeft className="w-6 h-6 text-gray-800" />
//                 </button>
//                 <button
//                     onClick={nextSlide}
//                     className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 lg:translate-x-12 z-10 bg-white rounded-full p-3 shadow-lg hover:bg-gray-100 transition-all"
//                 >
...
//                                 >
//                                     <div className="bg-white rounded-2xl overflow-hidden shadow-xl hover:transform hover:scale-105 transition-all duration-300">
//                                         {/* Image Section */}
