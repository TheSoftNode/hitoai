...
//         <div className="absolute inset-0 bg-[linear-gradient(45deg,#003366_1px,transparent_1px),linear-gradient(-45deg,#003366_1px,transparent_1px)] bg-[length:40px_40px]" />
//       </div>
...
//             Empowering Energy Intelligence
//           </h2>
//           <p className="text-lg text-gray-600 max-w-2xl mx-auto">
//             HItoai combines cutting-edge AI technology with energy expertise to deliver
//             smart, sustainable solutions that transform how businesses manage their energy resources.
//           </p>
//         </motion.div>
...
//               <Card className="h-full p-8 bg-gradient-to-br from-white to-blue-50 border-none shadow-lg">
//                 <div className="mb-6">
...
//                     Revolutionize energy management with AI-driven solutions that optimize usage,
//                     reduce costs, and promote sustainability for a greener future.
//                   </p>
//                 </div>
...
//           <motion.div variants={fadeInUp} whileHover="hover">
//             <motion.div variants={hoverScale}>
//               <Card className="h-full p-8 bg-gradient-to-br from-white to-purple-50 border-none shadow-lg">
//                 <div className="mb-6">
...
//                   <p className="text-gray-600 leading-relaxed">
//                     Lead the transition to sustainable energy management by empowering
//                     businesses and households with intelligent, data-driven solutions.
//                   </p>
//                 </div>
//                 <div className="mt-auto">
//                   <motion.div
...
//           <motion.div variants={fadeInUp} whileHover="hover">
//             <motion.div variants={hoverScale}>
//               <Card className="h-full p-8 bg-gradient-to-br from-white to-indigo-50 border-none shadow-lg">
//                 <div className="mb-6">
//                   <div className="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center mb-4">
//                     <Shield className="w-6 h-6 text-indigo-600" />
//                   </div>
//                   <h3 className="text-2xl font-bold text-[#003366] mb-4">Our Values</h3>
//                   <p className="text-gray-600 leading-relaxed">
//                     Built on the foundations of innovation, sustainability, efficiency,
//                     reliability, and unwavering commitment to customer success.
//                   </p>
//                 </div>
//                 <div className="mt-auto">
//                   <motion.div
...
//         >
//           <div className="inline-flex items-center bg-blue-50 rounded-full px-6 py-2 text-blue-600 font-medium text-sm mb-8">
//             Our Solutions
//           </div>
...
//                 >
//                     <div className="absolute inset-0 bg-[linear-gradient(45deg,#003366_1px,transparent_1px),linear-gradient(-45deg,#003366_1px,transparent_1px)] bg-[length:48px_48px]" />
//                 </motion.div>
...
//                     <h2 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#003366] to-blue-600 mb-6">
...
//                             icon: Zap,
//                             color: "blue",
//                             description: "Revolutionize energy management through AI-driven solutions that optimize usage, reduce costs, and champion sustainability for a greener tomorrow.",
//                         },
//                         {
//                             title: "Our Vision",
//                             icon: Globe,
//                             color: "purple",
//                             description: "Lead the global transition to intelligent energy management by empowering organizations with data-driven insights and automated optimization.",
//                         },
//                         {
//                             title: "Our Values",
//                             icon: Shield,
//                             color: "indigo",
//                             description: "Excellence in innovation, unwavering commitment to sustainability, operational efficiency, and dedicated focus on delivering exceptional value.",
//                         },
//                     ].map((item, index) => (
//                         <motion.div
//                             key={index}
...
//                         >
//                             <Card className="h-full p-8 bg-white/80 backdrop-blur-lg border-0 shadow-lg hover:shadow-xl transition-all">
//                                 <div className={`w-16 h-16 bg-${item.color}-100 rounded-2xl flex items-center justify-center mb-6 transform -rotate-6`}>
...
//                                 <motion.button
//                                     whileHover={{ x: 5 }}
//                                     className={`flex items-center text-${item.color}-600 font-medium`}
//                                 >
//                                     Discover More <ArrowUpRight className="w-4 h-4 ml-2" />
//                                 </motion.button>
//                             </Card>
//                         </motion.div>
//                     ))}
...
//                 >
//                     {[
//                         { icon: ChartBar, title: "Advanced Analytics", description: "Real-time energy consumption analysis" },
//                         { icon: Cpu, title: "AI Optimization", description: "Smart resource allocation & automation" },
//                         { icon: Network, title: "Smart Grid", description: "Seamless integration with modern infrastructure" },
//                         { icon: Shield, title: "Secure Platform", description: "Enterprise-grade security protocols" },
//                     ].map((feature, index) => (
//                         <motion.div
//                             key={index}
...
//                             className="group"
//                         >
//                             <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl hover:bg-white/80 transition-all">
...
//                                 </div>
//                                 <h4 className="text-lg font-semibold text-[#003366] mb-2">{feature.title}</h4>
